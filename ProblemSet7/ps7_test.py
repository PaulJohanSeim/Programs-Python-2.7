...
class NewsStory (object):
    ...
    #In command bar we define: test = NewsStory('foo', 'myTitle', 'mySubject', 'some long summary', 'www.example.com')
    #In command bar we run: test.getLink() which prints out foo
