...
class Grades(object):
    ...
    def addStudent(self, student):
        ...
        if student in self.students:                #List of student instances
    ...
    def addGrade(self, student, grade):
        ...
        try:
            self.grades[student.getIdNum()].append(grade)            #Student is an instance
        except KeyError:
...
def gradeReport(course):                        #Procedure/course is an instance of gradeReport
